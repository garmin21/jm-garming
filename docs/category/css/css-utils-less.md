...
### 5. 每逢大的灾难的时候，很多网站变成了灰色，如何让网站快速变灰？css代码是很简单的，用的是css的filter功能。
...
### 6. DIV可编辑，就是让一个div变成一个类似input输入框的效果。contentEditable="true" 属性
...
### 7. 有些网站为了不让用户复制，设置了div禁止选择的功能，设置如下属性：
