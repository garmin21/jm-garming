...
// CNY: 人民币
console.log(
  new NumberFormat("de-DE", { style: "currency", currency: "EUR" }).format(num)
); // 1.331.231,00 €
console.log(
  new NumberFormat("ja-JP", { style: "currency", currency: "JPY" }).format(num)
); // ￥1,331,231
console.log(
  new NumberFormat("zh-CN", { style: "currency", currency: "CNY" }).format(num)
); // ¥1,331,231.00
